...
namespace Test.HumanResources.Commands
{
    ...
    /// </summary>
    public sealed partial class DeletePersonCommandHandler : Library.Cqrs.Models.Commands.ICommandHandler<DeletePersonCommandParameter, DeletePersonCommandResult>
    {
