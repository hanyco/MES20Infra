...
public class Code(in string name, in Language language, in string statement, in bool isPartial = false, in string? fileName = null) : IEquatable<Code>
{
    ...
    /// <summary>
    /// Constructor for the Code class with parameters.
    /// </summary>
    ...
    /// <returns>An instance of the Code class.</returns>
    ...
    /// <summary>
    /// Constructor for the Code class with a copy of the original Code instance.
    /// </summary>
    ...
    /// <summary>
    /// Gets the file name of the code.
    /// If the file name is null or empty, generate a new file name based on the code's name, language, and partial status.
    /// </summary>
