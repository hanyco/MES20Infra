...
internal sealed class AccessPermissionRepository(IdentityDbContext context) : IAccessPermissionRepository
{
    ...
    public async Task<AccessPermission?> GetAccessPermission(string userId, long entityId)
    {
    ...
    public async Task<AccessPermission?> GetParentPermission(string userId, long entityId)
    {
    ...
    public async Task<AccessPermission?> GetAccessPermissionWithParent(string userId, long entityId)
    {
