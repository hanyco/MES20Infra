...
public interface IAccessPermissionRepository
{
    ...
    Task<AccessPermission?> GetAccessPermission(string userId, long entityId);
    ...
    Task<AccessPermission?> GetParentPermission(string userId, long entityId);

    Task<AccessPermission?> GetAccessPermissionWithParent(string userId, long entityId);
}
