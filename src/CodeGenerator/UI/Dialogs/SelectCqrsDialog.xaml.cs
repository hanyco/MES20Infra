...
public partial class SelectCqrsDialog
{
        ...
        where TViewModel : InfraViewModelBase
    {
        ...
        return dlg.ShowDialog() is not true
            ...
            {
                (true, _, _, DtoViewModel item) => result(true, item.As<TViewModel>()),
                (true, _, _, _) => result(true, null),

                (_, true, _, CqrsViewModelBase item) => result(true, item.As<TViewModel>()),
                (_, true, _, _) => result(true, null),

                (_, _, true, CqrsViewModelBase item) => result(true, item.As<TViewModel>()),
